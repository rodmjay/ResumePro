...
(function(global, factory) {
    ...
    (function(exports, $) {
        ...
        const FloatingLabel = function($) {
            ...
            $(document).on("".concat(Event.CHANGE, " ").concat(Event.FOCUSIN, " ").concat(Event.FOCUSOUT),
                ...
                for (let property in configTypes) {
                    if (Object.prototype.hasOwnProperty.call(configTypes, property)) {
                        ...
                        if (!new RegExp(expectedTypes).test(valueType)) {
                            throw new Error("".concat(componentName.toUpperCase(), ": ") +
        ...
        const NavDrawer = function($) {
                    ...
                    [
                        {
                            ...
                            value: function hide(event) {
                                ...
                                $(document.body).removeClass("".concat(ClassName.OPEN, "-").concat(this._config.type)
                                    .concat(this._typeBreakpoint));
                                $(this._element).removeClass(ClassName.SHOW);
                                $(this._element).off(Event.CLICK_DISMISS);
                                $(this._content).off(Event.MOUSEDOWN_DISMISS);
                                const transitionDuration = Util.getTransitionDurationFromElement(this._content);
                                $(this._content).one(Util.TRANSITION_END,
                                    function(event) {
                            ...
                            value: function show(relatedTarget) {
                                ...
                                $(this._element).addClass("".concat(NAME, "-").concat(this._config.type)
                                    .concat(this._typeBreakpoint));
                                ...
                                $(this._content).on(Event.MOUSEDOWN_DISMISS,
                                    function() {
                                        $(_this2._element).one(Event.MOUSEUP_DISMISS,
                                            function(event) {
                            ...
                            value: function _enforceFocus() {
                                ...
                                $(document).off(Event.FOCUSIN).on(Event.FOCUSIN,
                                    function(event) {
                                        if (document !== event.target &&
                                            _this3._element !== event.target &&
                                            $(_this3._element).has(event.target).length === 0) {
                            ...
                            value: function _setEscapeEvent() {
                                ...
                                if (this._isShown && this._config.keyboard) {
                                    $(this._element).on(Event.KEYDOWN_DISMISS,
                                        function(event) {
                            ...
                            value: function _showBackdrop() {
                                ...
                                if (this._isShown) {
                                    ...
                                    $(this._backdrop).addClass(ClassName.BACKDROP)
                                        .addClass("".concat(ClassName.BACKDROP, "-").concat(this._config.type)
                                            .concat(this._typeBreakpoint)).appendTo(document.body);
                                    $(this._element).on(Event.CLICK_DISMISS,
                                        function(event) {
                            ...
                            value: function _showElement(relatedTarget) {
                                ...
                                $(document.body).addClass("".concat(ClassName.OPEN, "-").concat(this._config.type)
                                    .concat(this._typeBreakpoint));
                                ...
                                const transitionDuration = Util.getTransitionDurationFromElement(this._content);
                                $(this._content).one(Util.TRANSITION_END, transitionComplete)
                                    .emulateTransitionEnd(transitionDuration);
                            }
                        }
                    ],
                    [
                        {
                            ...
                            value: function _jQueryInterface(config, relatedTarget) {
                                return this.each(function() {
                                    const _config =
                                        _objectSpread2(_objectSpread2(_objectSpread2({}, Default), $(this).data()),
            ...
            $(document).on(Event.CLICK_DATA_API,
                ...
                function(event) {
                    ...
                    var $target = $(target).one(Event.SHOW,
                        function(showEvent) {
            ...
            (function(factory) {
                ...
                function PickerConstructor(ELEMENT, NAME, COMPONENT, OPTIONS) {
                    ...
                    var
                        ...
                        ;
                    const PickerInstance = function() {
                        return this.start();
                    };
                    var P = PickerInstance.prototype = {
                            ...
                            if (dontGiveFocus !== false) {
                                ...
                                $document.on(`click.${STATE.id} focusin.${STATE.id}`,
                                    function(event) {
                                        ...
                                        const target = getRealEventTarget(event, ELEMENT);
                                    ...
                                    function(event) {
                                        ...
                                        const keycodeToMove = P.component.key[keycode];
                                        const target = getRealEventTarget(event, ELEMENT);
                                        ...
                                        // Check if there is a key movement or “enter” keypress on the element.
                                            ...
                                            else if (!P.$root.find(`.${CLASSES.highlighted}`)
                        ...
                        set: function(thing, value, options) {
                            ...
                            const thingIsObject = $.isPlainObject(thing);
                            const thingObject = thingIsObject ? thing : {};
                        ...
                        P.$holder.on({
                            ...
                            on("click",
                                ...
                                function() {
                                    ...
                                    const targetDisabled = $target.hasClass(CLASSES.navDisabled) ||
                                        $target.hasClass(CLASSES.disabled);
                                    var // * For IE, non-focusable elements can be active elements as well
                    ...
                    function prepareElementHidden() {
                        ...
                        P._hidden = $(
                            `<input type=hidden name="${name}"${$ELEMENT.data("value") || ELEMENT.value
                    ...
                    function focusPickerOnceOpened() {
                        ...
                        if (IS_DEFAULT_THEME && supportsTransitions) {
                            P.$holder.find(`.${CLASSES.frame}`).one("transitionend",
                                function() {
                                    P.$holder.eq(0).focus();
                                });
                        } else {
                    ...
                    function handleKeydownEvent(event) {
                        ...
                        const keycode = event.keyCode;
                        const isKeycodeDelete = /^(8|46)$/.test(keycode);
                ...
                function ariaAttr(attribute, data) {
                    ...
                    data = "";
                    for (let key in attribute) {
                        const attr = (key == "role" ? "" : "aria-") + key;
                        const attrVal = attribute[key];
        ...
        (function(module, exports) {
            (function(factory) {
                ...
                function DatePicker(picker, settings) {
                    ...
                    calendar.key = {
                        ...
                        go: function(timeChange) {
                            ...
                            const targetDate = new Date(highlightedObject.year,
                        ...
                        function() {
                                ...
                                function() {
                                    ...
                                    if (value) {
                                        picker.set("highlight",
                                            [picker.get("view").year, value, picker.get("highlight").date]);
                            ...
                            picker.$root.find(`.${settings.klass.selectYear}`).on("change",
                                function() {
                                    ...
                                    if (value) {
                                        picker.set("highlight",
                                            [value, picker.get("view").month, picker.get("highlight").date]);
                ...
                DatePicker.prototype.set = function(type, value, options) {
                    ...
                    var calendar = this;
                    const calendarItem = calendar.item;
            ...
            safety = 100*/
                    ...
                    if (isTargetArray || isTargetObject) {
                        ...
                        targetDateObject =
                            new Date(targetYear, targetMonth + (options && options.nav ? options.nav : 0), 1);
            ...
            safety = 100*/
                    ...
                    if (!options || (!options.nav && !options.defaultValue))
                        if (
                            ...
                            while (/*safety &&*/ calendar.disabled(dateObject)) {
                                ...
                                dateObject = calendar.create([
                                    dateObject.year, dateObject.month, dateObject.date + interval
                                ]);
                            }
                ...
                DatePicker.prototype.parse = function(type, value, options) {
                    ...
                    calendar.formats.toArray(options.format).map(function(label) {
                        ...
                        const formattingLabel = calendar.formats[label];
                ...
                DatePicker.prototype.formats = (function() {
                    ...
                    function getWordLengthFromCollection(string, collection, dateObject) {
                        ...
                        const word = string.match(/[^\x00-\x7F]+|\w+/)[0];
                ...
                DatePicker.prototype.isDateOverlap = function(one, two) {
                    ...
                    const calendar = this;
                    const firstDay = calendar.settings.firstDay ? 1 : 0;
                ...
                DatePicker.prototype.nodes = function(isOpen) {
                    ...
                    var
                        ...
                        ;
                    const calendarItem = calendar.item;
                    var nowObject = calendarItem.now,
                    ...
                    const tableHead = (function(collection, fullCollection) {
                    ...
                    const createMonthNav = function(next) {
                        ...
                        return _.node(
                            ...
                            `data-nav=${next || -1} ${_.ariaAttr({
                                role: "button",
                                controls: calendar.$node[0].id + "_table"
                            })} title="${next ? settings.labelMonthNext : settings.labelMonthPrev}"`
                        ); //endreturn
                    };
                    const createMonthLabel = function() {
                    ...
                    const createYearLabel = function() {
                        ...
                        var focusedYear = viewsetObject.year
                            ...
                            ;
                        const numberYears = settings.selectYears === true ? 5 : ~~(settings.selectYears / 2);

                        // If there are years to select, add a dropdown menu.
                        if (numberYears) {

                            const minYear = minLimitObject.year;
                            const maxYear = maxLimitObject.year;
                            let lowestYear = focusedYear - numberYears;
                            let highestYear = focusedYear + numberYears;
                            ...
                            if (maxYear < highestYear) {
                                ...
                                const availableYears = lowestYear - minYear;
                                const neededYears = highestYear - maxYear;
                    ...
                    return _.node(
                            ...
                            _.node(
                                ...
                                _.group({
                                    ...
                                    item: function(rowCounter) {
                                        ...
                                        const shiftDateBy = settings.firstDay &&
                                        ...
                                        return [
                                            _.group({
                                                ...
                                                item: function(targetDate) {
                                                    ...
                                                    const formattedDate = _.trigger(calendar.formats.toString,
                                                        calendar,
                        ...
                        _.node(
                            ...
                            _.node("button",
                                ...
                                `type=button data-pick=${nowObject.pick}${isOpen && !calendar.disabled(nowObject)
                                ? ""
                                : " disabled"} ${_.ariaAttr({ controls: calendar.$node[0].id })}`) +
                            _.node("button",
                                settings.clear,
                                settings.klass.buttonClear,
                                `type=button data-clear=1${isOpen ? "" : " disabled"} ${_.ariaAttr({
                                    controls: calendar.$node[0].id
                                })}`) +
                            _.node("button",
                                settings.close,
                                settings.klass.buttonClose,
                                `type=button data-close=true ${isOpen ? "" : " disabled"} ${_.ariaAttr({
                                    controls: calendar.$node[0].id
                                })}`),
                    ...
                    [
                        {
                            ...
                            value: function display(datepickerApi, datepickerRoot, datepickerValue) {
                                ...
                                $(".picker-wrap", datepickerRoot).prepend(
                                    "<div class=\"picker-date-display\"><div class=\"picker-date-display-top\"><span class=\"picker-year-display\">"
                                    .concat(datepickerApi.get(datepickerValue, "yyyy"),
                                        "</span></div><div class=\"picker-date-display-bottom\"><span class=\"picker-weekday-display\">")
                                    .concat(datepickerApi.get(datepickerValue, "dddd"),
                                        "</span><span class=\"picker-month-display\">")
                                    .concat(datepickerApi.get(datepickerValue, "mmm"),
                                        "</span><span class=\"picker-day-display\">")
                                    .concat(datepickerApi.get(datepickerValue, "d"), "</span></div></div>"));
                            }
                        }, {
                            key: "show",
                            value: function show() {
        ...
        function ripplet(_a, _options) {
            ...
            var options = _options
                ? Object.keys(defaultOptions).reduce(function(merged, field) {
                        return ((merged[field] =
                            _options.hasOwnProperty(field) ? _options[field] : defaultOptions[field]), merged);
                    },
                    {})
                : defaultOptions;
            ...
            var removingElement = containerElement;
            {
                ...
                if (targetStyle.position === "fixed" || (targetStyle.position === "absolute" && appendToParent)) {
                    ...
                    if (parentStyle.display === "flex" || parentStyle.display === "inline-flex") {
                        ...
                        var containerContainerRect =
                            containerContainer.getBoundingClientRect(); // this may be a slow operation...
                    ...
                    body.appendChild(containerElement);
                    containerStyle.position = "absolute";
                    var p = transformPoint(transformMatrix,
            ...
            }
            {
                ...
                rippletStyle.transition =
                    `transform ${applyCssVariable(options.spreadingDuration)} ${
                    applyCssVariable(options.spreadingTimingFunction)} ${applyCssVariable(options.spreadingDelay)
                    },opacity ${applyCssVariable(options.clearingDuration)} ${
                    applyCssVariable(options.clearingTimingFunction)} ${applyCssVariable(options.clearingDelay)}`;
                ...
                rippletElement.addEventListener("transitionend",
                    function(event) {
        ...
        ripplet.clear = function(targetElement, rippletContainerElement) {
            if (targetElement) {
                ...
                target2container2ripplet.forEach(function(container2ripplet) {
                    return container2ripplet.forEach(function(r) { return (r.style.opacity = "0"); });
                });
                ...
                function(event) {
                    ...
                    const currentTarget =
                        event.target.closest(
                            ".btn, .card-link, .card-primary-action, .list-group-item-action, [data-ripplet]");
                    ...
                    if (cls.contains("btn-outline-primary") ||
                    ...
                    } else if (cls.contains("btn-primary") ||
        ...
        const SelectionControlFocus = function($) {
            // constants >>>
                    ...
                    [
                        {
                            ...
                            value: function _switch(element, relatedTarget) {
                                ...
                                $(this._navindicator).one(Util.TRANSITION_END, complete)
                                    .emulateTransitionEnd(transitionDuration);
                            }
                        }, {
