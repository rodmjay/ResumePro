        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Solution Stream", null, null, "American Fork,UT", 1, new DateTime(2020, 11, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sr. Software Architect" },
                    { 3, "IdeaFortune", null, null, "American Fork,UT", 1, new DateTime(2017, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Founder/Architect" },
                    { 4, "Agile Software", null, null, "Sacramento,CA", 1, new DateTime(2016, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Architect" },
                    { 5, "Access Softek", null, null, "West Jordan,UT", 1, new DateTime(2014, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sr. Engineer Dev Lead" },
                    { 6, "NETCHEX", null, new DateTime(2013, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Louisiana", 1, new DateTime(2012, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Architect Consultant" },
                    ...
                    { 8, "Cathexis", null, new DateTime(2010, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Provo,UT", 1, new DateTime(2008, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Architect/Dev Manager" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Rod is an enterprise architect with expertise in the latest .NET and web technologies.  Rod has 19 years of experience as a professional developer and architect, with expertise in the complete software development lifecycle from ideation to implementation.  Rod is consistently described as a 10x developer who delivers high-end software from the ground up.", 1, "Enterprice Application Architect" });
