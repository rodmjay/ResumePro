    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">
                ...
                as a CLI project. Current versions is Angular v19 with PrimeNG
                v19. In case CLI is not installed already, use the command below
                to set it up.
            </p>
            <pre class="app-code">
<code>npm install -g &#64;angular/cli</code></pre>
            ...
            <pre class="app-code">
<code>git clone https://github.com/primefaces/apollo-ng
npm install
ng serve</code></pre>
            ...
            <ul class="leading-normal list-disc pl-8 text-lg mb-4">
                <li>
                    <span class="text-primary font-medium">src/app/layout</span
                    >: Main layout files, needs to be present.
                </li>
                <li>
                    <span class="text-primary font-medium">src/app/pages</span>:
                    Demo pages like Dashboard.
                </li>
                <li>
                    <span class="text-primary font-medium"
                        >public/demo/images/landing</span
            ...
            <p class="text-lg mb-4">
                ...
                <span
                    class="bg-highlight px-2 py-1 rounded-border not-italic text-base"
                    >src/app/layout/core/app.menu.ts</span
                >
                file. Update the
                <i
                    class="bg-highlight px-2 py-1 rounded-border not-italic text-base"
