...
[Route("v1.0/jobs/{jobId}/projects")]
public sealed class ProjectsController(IServiceProvider serviceProvider, IProjectService projectService)
    : BaseController(serviceProvider), IIndividualProjectsController
{
    [HttpGet("{projectId}")]
    public async Task<ProjectDetails> GetProject([FromRoute] int jobId,
    ...
    [HttpGet]
    public async Task<List<ProjectDetails>> GetList([FromRoute] int jobId)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<ProjectDetails>> CreateProject([FromRoute] int jobId,
    ...
    [HttpPut("{projectId}")]
    public async Task<ActionResult<ProjectDetails>> Update([FromRoute] int jobId,
    ...
    public async Task<Result> Delete([FromRoute] int jobId,
        [FromRoute] int projectId)
    {
